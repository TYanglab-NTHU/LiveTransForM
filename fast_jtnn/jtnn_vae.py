...
class JTNNVAE(nn.Module):
    ...
    def __init__(self, vocab, hidden_size, latent_size, depthT, depthG, dev0=0, dev1=0):
    ...
    def forward(self, x_batch, beta):
        # x_jtenc_holder = x_jtenc_holder.to(self.dev0)
        # x_mpn_holder = x_mpn_holder.to(self.dev0)
        # x_jtmpn_holder = x_jtmpn_holder.to(self.dev0)
        ...
        # x_jtenc_holder = x_jtenc_holder.to(self.dev1)
        # x_mpn_holder = x_mpn_holder.to(self.dev1)
        # x_jtmpn_holder = x_jtmpn_holder.to(self.dev1)
